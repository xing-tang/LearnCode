package com.open.learncode.算法.old.wcopy.剑指offer.J_二叉树相关算法;
...
public class TestMethod26 {
     ...
     */
    public static boolean method(TreeNode<Integer> A, TreeNode<Integer> B) {
        return (A != null && B != null) && (methodChild(A, B) || method(A.left, B) || method(A.right, B));
    }
