...
public class ImageCacheAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (null == convertView) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_image_cache, parent, false);
...
//                80, 80, false);
        ...
        if(null==bitmap){
            ...
            if(null==bitmap){
                ...
                Log.i("BitmapCache","从网络加载了数据");
            }else{
                Log.i("BitmapCache","从磁盘中加载了数据");
            }

        }else{
            Log.i("BitmapCache","从内存中加载了数据");
        }
