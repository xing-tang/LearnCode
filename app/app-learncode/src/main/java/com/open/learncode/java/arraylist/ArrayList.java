...
//        } else {//当initialCapacity为负数的时候为非法
...
//     *
//     * @param o 元素
//     * @return true为包含该元素，false为不包含该元素
//     */
...
//     *
//     * @param o 元素
//     * @return 返回-1代表没有当前这个元素，否则返回当前元素在集合中第一次出现的索引位置
//     */
//    public int indexOf(Object o) {
//        //判断元素o是否为null，ArrayList集合允许存储的值为空
//        if (o == null) {
...
//     *
//     * @param o 元素
//     * @return 返回-1代表没有当前这个元素，否则返回当前元素在集合中最后一次出现的索引位置
//     */
