...
public class JZ26_树的子结构 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("二叉树B是不是二叉树A的子结构：" + solution(rootA8, rootB8));
    }
    ...
    public static boolean solution(TreeNode<Integer> A, TreeNode<Integer> B) {
        return (A != null && B != null) && (solutionChild(A, B) || solution(A.left, B) || solution(A.right, B));
    }
     ...
     * @return 返回二叉树B是否是二叉树A的子结构
     */
    public static boolean solutionChild(TreeNode<Integer> A, TreeNode<Integer> B) {
        if (B == null) return true;
        if (A == null || A.val != B.val) return false;
        return solutionChild(A.left, B.left) && solutionChild(A.right, B.right);
    }
