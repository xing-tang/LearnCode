...
public class OT11_字符串的最长不重复子串 {
    ...
    public static void main(String[] args) {
        ...
        // String str = "abcabcab";
        PrintUtils.getInstance().print(solution1(str), "最长的不含重复字符的子字符串的长度是：");
        System.out.println("最长的不含重复字符的子字符串的长度是：" + solution1(str));
        System.out.println("最长的不含重复字符的子字符串的长度是：" + solution2(str));
    }
