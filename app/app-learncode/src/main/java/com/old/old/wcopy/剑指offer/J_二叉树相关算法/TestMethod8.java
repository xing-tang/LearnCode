...
public class TestMethod8 {
    ...
    public static void main(String[] args) {
        ...
        // 分别获取节点b、d、e、g的下一个节点
        System.out.println(nodeB.next + "在中序遍历中下一个节点是：" + method(nodeB).next);
        System.out.println(nodeD.next + "在中序遍历中下一个节点是：" + method(nodeD).next);
        System.out.println(nodeE.next + "在中序遍历中下一个节点是：" + method(nodeE).next);
        System.out.println(nodeG.next + "在中序遍历中下一个节点是：" + method(nodeG));
    }
